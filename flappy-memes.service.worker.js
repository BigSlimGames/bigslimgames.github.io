...
/** @type {string} */
const CACHE_VERSION = '1729537168|981790884';
/** @type {string} */
const CACHE_PREFIX = 'Flappy Memes-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'flappy-memes.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["flappy-memes.html","flappy-memes.js","flappy-memes.offline.html","flappy-memes.icon.png","flappy-memes.apple-touch-icon.png","flappy-memes.worker.js","flappy-memes.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["flappy-memes.wasm","flappy-memes.pck"];
